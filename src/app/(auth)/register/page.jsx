...
const Register = () => {
  ...
  if (loading) {
    return (
      <section className='relative flex flex-col items-center justify-center min-h-[calc(100vh-64px)] bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900'>
        <div className='text-center'>
          <div className='inline-flex items-center justify-center w-12 h-12 rounded-full bg-gradient-to-r from-cyan-400 to-green-400 animate-spin mb-4'>
    ...
    <section className='relative flex flex-col items-center justify-center min-h-[calc(100vh-64px)] bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 overflow-hidden'>
      ...
      <div className='relative z-10 w-full max-w-md px-4 sm:px-0'>
        <div className='text-center mb-8 sm:mb-12'>
          ...
          <p className='text-gray-400 text-sm sm:text-base'>Join our community</p>
        </div>
        <div className='backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl shadow-2xl shadow-cyan-500/20 overflow-hidden'>
          ...
          <div className='p-6 sm:p-8 text-center'>
            <p className='text-gray-400 text-sm'>
              ...
              <Link href='/login' className='text-cyan-400 font-semibold hover:text-green-400 transition-colors'>
                Login here
              </Link>
            </p>
          </div>
