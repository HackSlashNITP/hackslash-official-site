...
function Card({ imgSrc, title, description, buttonText }) {
  return (
    <>
    <div className="bg-gray-800 rounded-lg overflow-hidden shadow-lg transition transform hover:scale-105  mx-auto">
      ...
      <div className="rounded-b-[10px] bg-[#223345] p-4 hover:bg-[#00FF9D]">
        ...
        <button 
          type="button" 
          className="text-transparent-900 bg-[#223345] text-white border border-white-400 focus:outline-none font-medium rounded-2xl text-sm px-6 py-2 mx-auto block hover:bg-gray-700"
        >
          {buttonText}
        </button>
      </div>    
