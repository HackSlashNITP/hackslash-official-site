        ...
        <div className="flex flex-col ml-9 md:flex-row md:justify-between md:items-start text-center md:text-left">
          ...
          <div className="flex flex-col items-center mb-8 w-full md:w-1/3 md:items-start">
            ...
            <div className="flex gap-7">
              ...
              <Link href="#"><Image src="/icons/youtube.svg" alt="YouTube" width={20} height={20} /></Link>
              <Link href="#"><Image src="/icons/twitter-x.svg" alt="Twitter" width={20} height={20} /></Link>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center md:items-start md:flex-row md:space-x-16 mb-8 md:mb-0 w-full md:w-2/3">
            <div className="mb-8 md:mb-0 w-full md:w-1/2">
              ...
              <ul className="space-y-3 text-md">
                ...
                <li><Link href="#" className="hover:text-green-400">Terms and Condition</Link></li>
                <li><Link href="#" className="hover:text-green-400">Sponsor us</Link></li>
          ...
          <div className="w-full md:w-1/4 mt-8 md:mt-0">
            ...
            <p className="text-md hover:text-green-400 cursor-pointer">Patna university campus,<br/> Patna, Bihar 800005
            </p>
          </div>
        </div>
      </div>
